<?php
    ...
    $saltado = false;
    $insertar = "INSERT INTO sicas_test.alumnos (Matricula, NombreAlumno, ApellidoPaternoAlumno, ApellidoMaternoAlumno, IDPlanEstudio, CorreoAlumno, Genero, IDUsuario, IDModelo, NivelEducativo) VALUES (?,?,?,?,?,?,?,?,?,?)";
