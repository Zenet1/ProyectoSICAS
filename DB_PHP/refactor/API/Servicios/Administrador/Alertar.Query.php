...
class AlertaQuery
{
    ...
    public function __construct()
    {
        ...
        $this->SELECTInvol = "SELECT ALM.CorreoAlumno AS CORREO,ALM.NombreAlumno AS NOMBRE,ALM.ApellidoPaternoAlumno AS APELLIDOP,ALM.ApellidoMaternoAlumno AS APELLIDOM FROM cargaacademica AS CGAC INNER JOIN asistenciasalumnos AS ASAL ON ASAL.IDAlumno=CGAC.IDAlumno INNER JOIN alumnos AS ALM ON ALM.IDAlumno=CGAC.IDAlumno WHERE CGAC.IDGrupo=:idg AND ASAL.FechaAl=:fch AND ALM.Matricula!=:mat";
