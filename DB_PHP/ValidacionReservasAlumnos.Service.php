...
function validarReservaNoExistente(PDO $Conexion): string
{
    ...
    $Respuesta = "Aceptado";
    $sql_recuperarReservaciones = "SELECT RSV.IDCarga FROM reservacionesalumnos AS RSV INNER JOIN cargaacademica AS CGAC ON RSV.IDCarga=CGAC.IDCarga WHERE CGAC.IDAlumno=? AND RSV.FechaAlumno=?";
